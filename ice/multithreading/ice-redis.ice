...
module CommandArea {
   interface DataCommand {
        ...
        YCArea::DxDTYCSeq RPCGetDayYCData (string datetime, long pID);
        YCArea::DxDTYCSeq RPCGetPeriodYCData(string datetime0, string datetime1, long pID);
        ...
        YXArea::DxDTYXSeq RPCGetDayYXData (string datetime, long pID);
        YXArea::DxDTYXSeq RPCGetPeriodYXData(string datetime0,string datetime1, long pID);
