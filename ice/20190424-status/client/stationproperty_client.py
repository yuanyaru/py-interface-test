...
try:
    ...
    stationpropertystatus = DataCommand.RPCSetStationProperty(structstationproperty)
    print(stationpropertystatus)
    stationpropertystatus,structstationproperty = DataCommand.RPCGetStationProperty()
    print(stationpropertystatus)
