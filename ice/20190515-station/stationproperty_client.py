...
try:
    ...
    station = 1
    stationpropertystatus = DataCommand.RPCSetStationProperty(station, structstationproperty)
    print(stationpropertystatus)
    stationpropertystatus,structstationproperty = DataCommand.RPCGetStationProperty(station)
    print(stationpropertystatus)
